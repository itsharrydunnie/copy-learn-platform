...
previewRoutes.get(
  "/transactional/scholarship-approved",
  (req: Request, res: Response, next: NextFunction) => {
    const templatePath = "emails/transactional/scholarship-approved";

    const sampleData = {
      subject: "Congratulations! Your Scholarship Has Been Approved!",
      salute: "Hi Harry,",
      bodyOne:
        "Your scholarship application for Backend Engineering has been approved.",
      bodyTwo:
        "You can now secure your place in Onaeko Academy, Backend Engineering Program at the discounted scholarship price of ₦65,000.",
      bodyThree:
        "Once your payment is confirmed, your enrollment will be activated.",
      buttonText: "Complete Enrollment",
      buttonUrl: "https://paystack.shop/pay/ai-for-everyone-test",
    };
...
previewRoutes.get(
  "/transactional/course-enrollment-confirmed",
  (req: Request, res: Response, next: NextFunction) => {
    const templatePath = "emails/transactional/course-enrollment-confirmed";

    const sampleData = {
      subject: "You're officially enrolled!",
      salute: "Hi Harry,",
      bodyOne:
        "Your payment for Backend Engineering Program has been confirmed.",
      bodyTwo:
        "You are now officially enrolled in the Onaeko Backend Engineering Program.",
      bodyThree:
        "You can now access your Onaeko course content and begin your learning journey.",
      buttonText: "Go to My Course",
      buttonUrl: "http://localhost:3000/courses/backend-engineering",
    };
  ...
  (req: Request, res: Response, next: NextFunction) => {
    ...
    const sampleData: Record<string, any> = {
      ...
      "newsletter-suscriber": {
        name: "Damola",
        unsubscribeLink: "https://pacepard.com/unsubscribe?token=xyz789",
      },
      "first-week": {
        name: "Damola",
        templateLink: "https://pacepard.com/templates",
