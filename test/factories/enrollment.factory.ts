...
export const buildEnrollment = (overrides: Record<string, unknown> = {}) => ({
...
export const createEnrollment = async (overrides: Record<string, unknown> = {}) =>
  Enrollment.create(buildEnrollment(overrides));
